# Try this out on Repl.it website
...
def tableValue(val):
  while(True):
    try:
      ...
      print("")
      print(color("Please enter numbers", "red"))
      print("")
      continue
    else:
      break
    ...
    if(decide == 'a'):
      while(True):
        try:
          ...
          print("")
          print(color("Please enter only numbers", "red"))
          continue
        else:
          break
      x.append(addX)
      ...
      print("")
      print(color("Please enter a or b", "red"))
...
def calc(b0, b1, deci):
  ...
  print("")
  if(b1 > 0):
    cal = "{} + {}({}) = {}".format(roundb0, roundb1, ins, calculation)
  else:
    cal = "{} - {}({}) = {}".format(roundb0, abs(roundb1), ins, calculation)
  print("")
  return cal
...
while(True):
  ...
  while(True):
    ...
    if (verify == True):
      print("")
      print(color("Calculation: {}".format(cal), "cyan"))
    ...
    if(co == True):
      print("")
      print(color("The numbers you entered are dividing by 0 in the Standard Deviation and in r", "red"))
      print("")
      break
    ...
    while(True):
      ...
      print("")
      if(t == False):
        print(color("Updated the regression line, the predicted values, and the residual values", "cyan"))
        print("")
      ...
      while(True):
        ...
        if(ask == 'a' or ask == 'b'):
          ...
          print("")
          print(color("Please enter a (add) or b (remove)", "red"))
      
      if(ask == 'a'):
        addRem(x, y)
        break
      if(ask == 'b'):
        cal = calc(roundb0, roundb1, decimal)
        verify = True
        break
